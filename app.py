...
/* 3) Also show the same caret beside the Filter label text (synced via JS below) */
label[for="flt"]{
  position:relative;
  padding-left:18px; /* space for caret */
}
...
with col3:
    all_option = "All"
    # If st.popover exists, we still use the selectbox inside (your structure preserved)
